...
- [ ] **10.4** Scan for text boxes (`visualType: "textbox"`) and buttons (`visualType: "actionButton"`) with English content

- [ ] **10.5** Scan for bookmark display names

- [ ] **10.6** Scan for tooltip page titles

- [ ] **10.7** Final validation — comprehensive English audit:
  ```bash
...
- [ ] **10.8** Close Power BI Desktop, reopen .pbip, visually verify all pages. Save project.
